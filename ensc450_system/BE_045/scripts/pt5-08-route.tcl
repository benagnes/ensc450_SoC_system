...
# global power nets - deprecated cmds
...
timeDesign  -slackReports -pathreports -expandReg2Reg -expandedViews \
            -reportOnly -numPaths 10 -hold -outDir results/timing/pt5-08-route-timeDesign.hold
...
timeDesign -drvReports -slackReports -pathreports -expandReg2Reg -expandedViews \
           -reportOnly -numPaths 10 -outDir results/timing/pt5-08-route-timeDesign.setup
