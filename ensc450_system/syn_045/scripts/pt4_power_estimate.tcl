...
# need core adapter back-end netlist here
read_verilog -netlist ../BE_045/best_part2_results/verilog/core_adapter.ref.v
read_verilog -netlist ./part4_12ns_results/ensc450.ref.v
...
#    report_power -analysis_effort high > ./results/power_analysis_55Mhz_vcd.rpt
    ...
    report_power -analysis_effort high -verbose -hierarchy > ./vcd_front_end/12ns_vcd_ensc450.rpt
}
